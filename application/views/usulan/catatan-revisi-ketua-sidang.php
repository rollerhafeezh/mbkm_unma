	...
	<table width="100%" border="1" cellspacing="0" cellpadding="5">
		<tr>
			<td width="100%" height="650" valign="top">
				...
				<?php
				if ($data != '') {
					$bimbingan	= json_decode($this->curl->simple_get(ADD_API.'aktivitas/bimbingan?level_name=Dosen&id_aktivitas='.$aktivitas_mahasiswa[0]->id_aktivitas.'&jenis_bimbingan=3')) ?: [];
					$no = 1;
