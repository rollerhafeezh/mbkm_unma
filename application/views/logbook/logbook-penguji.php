...
<body style="font-family: calibri; font-size: 11pt">
	...
	<table width="100%">
		<tr>
			<td><center><h3>CATATAN REVISI SEMINAR <?= acronym($usulan[0]->nm_mk) ?></h3></center></td>
		</tr>
	</table>
	<br>
	...
	<table width="100%">
		<tr>
			...
			<td align="center">
				...
				<br>
				<br>
				<strong style="text-decoration: underline;"><?= count($penguji) > 0 ? $penguji[0]->nm_sdm : 'Belum Diatur' ?></strong>
			</td>
		</tr>
	</table>
</body>
